...
const scrollContentSection = document.getElementById("contentSection");
const scrollChaptersAsideBar = document.getElementById("chaptersAsideBar");
...
function updateHeight() {
    ...
    const newHeight = screenHeight - 99;
...
const playerButton = document.querySelector('.player-button'),
    ...
    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z" clip-rule="evenodd" />
      ...
      `,
      pauseIcon = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#bbbbbb">
...
function changeSeek() {
    ...
    // Delay the visual update of the progress bar
    setTimeout(() => {
        const percentagePosition = (100 * audio.currentTime) / audio.duration;
        timeline.style.backgroundSize = `${percentagePosition}% 100%`;
    }, 1); // 500ms delay to create lagging effect
}
