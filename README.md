...
- **Knowledge of Syntax:** Since most might not know how to code (You should probly learn since its annoying to work with the syntax). We have a special syntax for making Language Documentation Pages. You can find this in the section "Language Documentation Page Syntax"
...
- **List (- List):** Only use this for teaching a lot of stuff that are similar. Like, numbers, jobs, or food if they don't have many diffrent conjergations.
